...
C_INCLUDES += $(DIRECTORIES) -I/usr/local/mysql/include/
...
LIBRARIES = -L/usr/local/mysql/lib/ -lmysqlclient -framework CoreFoundation -framework CoreServices -framework Cocoa
